...
[       Tooltip("Ease type for the fade tween.")]
       ...
       // ▼▼▼ [추가할 코드 시작] ▼▼▼
       [Tooltip("Duration for dimming portraits (When not speaking).")]
       [SerializeField] protected float dimFadeDuration = 0.3f; // 기본값 0.3초
    // ▲▲▲ [추가할 코드 끝] ▲▲▲
        ...
        // ▼▼▼ [추가할 코드 시작] ▼▼▼
        /// <summary>
        /// Duration for dimming portraits.
        /// </summary>
        public virtual float DimFadeDuration { get { return dimFadeDuration; } set { dimFadeDuration = value; } }
        // ▲▲▲ [추가할 코드 끝] ▲▲▲
